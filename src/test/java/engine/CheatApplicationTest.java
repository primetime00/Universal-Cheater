...
public class CheatApplicationTest {
    ...
    public void testPopulateGames() {
        ...
        assertEquals(6, list.getGameList().size());
        ...
        assertEquals("Unit Script Test Game", list.getGameList().get(3).getGame());
        assertEquals("Unit Test Game", list.getGameList().get(4).getGame());
